<template>
	<ul class="pagination w-100 m-0">
		<li class="page-item text-center" style="width: 15%;">
			<a class="p-1 page-link" @click="start()">«</a>
		</li>

		<!-- Left -->
		<li class="page-item text-center" style="width: 25%;">
			<a class="p-1 page-link" @click="prev()">⟵</a>
		</li>

		<!-- Page Number -->
		<li class="page-item text-center" style="width: 20%;">
			<a class="p-1 page-link">{{ badgeValue }}</a>
		</li>

		<!-- Right -->
		<li class="page-item text-center" style="width: 25%;">
			<a class="p-1 page-link" @click="next()">⟶</a>
		</li>

		<li class="page-item text-center" style="width: 15%;">
			<a class="p-1 page-link" @click="end()">»</a>
		</li>
	</ul>
</template>
